...
String name_of_folder = "Learning programming";
    ...
    public void testFindElementAndClick() {
        ...
        String search_result_locator = "//*[@resource-id='org.wikipedia:id/page_list_item_container']//*[@text='Java (programming language)']";
        waitForElementPresent(
                By.xpath(search_result_locator),
                "Cannot find anything by the request " + search_line,
                15
        );
        String search_result_locator1 = "//*[@resource-id='org.wikipedia:id/page_list_item_title']//*[@text='Java (programming language)']";

        assertElementPresent(
                By.xpath(search_result_locator1),
                "No such title for " + search_line,
                15
        );
       Assert.assertTrue(driver.getTitle().contains("Java (programming language)"));
    }
    ...
    private void findTheElementsPresent(By by, String error_message) {
    ...
    {
        WebElement element_present = waitForElementPresent(by, error_message, timeoutInSeconds);
